...
public class TrialCrawler extends BreadthCrawler {
	 ...
	 */
	public TrialCrawler(String crawlPath, boolean autoParse) {
	...
	public static void main(String[] args) throws Exception {
		...
		TrialCrawler crawler = new TrialCrawler(PATH_CRAWL_DATA1,
				true);
		...
		// HttpRequesterImpl
		// requester=(HttpRequesterImpl)crawler.getHttpRequester();

		// 单代理 r
		// equester.setProxy("127.0.0.1", 8080,Proxy.Type.SOCKS);
