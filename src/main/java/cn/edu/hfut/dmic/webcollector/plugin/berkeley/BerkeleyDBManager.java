...
public class BerkeleyDBManager extends DBManager {
	...
	public void inject(CrawlDatum datum, boolean force) throws Exception {
		...
		value = BerkeleyDBUtils.strToEntry(CrawlDatumFormater
				.datumToJsonStr(datum));
	...
	public void initSegmentWriter() throws Exception {
		...
		linkDatabase = env.openDatabase(null, "link",
				BerkeleyDBUtils.defaultDBConfig);
		redirectDatabase = env.openDatabase(null, "redirect",
				BerkeleyDBUtils.defaultDBConfig);
	...
	public void writeRedirectSegment(CrawlDatum datum, String realUrl)
			throws Exception {
